...
public class SandboxArreglos
{
    ...
    public int[] getCopiaEnteros( )
    {
        ...
        System.arraycopy(arregloEnteros, 0, copiaArregloEnteros, 0, arregloEnteros.length );
    ...
    public String[] getCopiaCadenas( )
    {
        ...
        System.arraycopy(arregloCadenas,  0,  copiaArregloCadenas, 0, arregloCadenas.length);
    ...
    public void agregarEntero( int entero )
    {
    	...
    	System.arraycopy(arregloEnteros, 0, nuevoArregloEnteros, 0, arregloEnteros.length);
    ...
    {
    	int nuevoLargo = arregloEnteros.length;
    	int numero = 0;
    	for (int i = 0; i < arregloEnteros.length; i++) {
    		if (arregloEnteros[i] == valor) {
    			...
    			if (i != nuevoLargo) {
    				arregloEnteros[numero] = arregloEnteros[i];
    				
    		}	numero ++;
    		}
    	}
    	arregloEnteros = Arrays.copyOf(arregloEnteros, nuevoLargo);
    }
    ...
    {
    	int nuevoLargo = arregloCadenas.length;
    	int numero = 0;
    	for (int i = 0; i < arregloCadenas.length; i++) {
    		if (arregloCadenas[i].equals(cadena)) {
    			...
    			if (i != nuevoLargo) {
    				arregloCadenas[numero] = arregloCadenas[i];
    				
    		}	numero ++;
    		}
    	}
    	arregloCadenas = Arrays.copyOf(arregloCadenas, nuevoLargo);
    }
    ...
    public void eliminarEnteroPorPosicion( int posicion )
    {
    	if (posicion >= 0 && posicion < arregloEnteros.length) {
    		...
    		System.arraycopy(arregloEnteros, posicion + 1, nuevoArregloEnteros, posicion, arregloEnteros.length - posicion - 1);
    		arregloEnteros = nuevoArregloEnteros;
    	}
    }
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
    	...
    	for (int i = 0; i < valores.length; i++ ) {
    		nuevoArregloEnteros[i] = (int) Math.floor(valores[i]);
    	}
    	arregloEnteros = nuevoArregloEnteros;
    }
    ...
    public int[] buscarEntero( int valor )
    {
        ...
        System.arraycopy(posiciones, 0, resultado, 0, contar);
        return resultado;
    }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        for (int entero: otroArreglo) {
        	if (!histograma.containsKey(entero) || histograma.get(entero) == 0) {
        		return false;
        	}
