...
public class SandboxListas
{
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        for (String currentString : listaCadenas) {
            if (!currentString.equalsIgnoreCase(cadena)) {
    ...
    {
    	int index = (posicion < 0) ? 0 : ((posicion > listaEnteros.size()) ? listaEnteros.size() : posicion);
    ...
    {
    	listaEnteros.sort(Integer::compareTo);
    }
    ...
    {
    	listaCadenas.sort((a, b) -> a.compareToIgnoreCase(b));
    }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
        ...
        for (int i = 0; i < cantidad; i++) {
            int randomNumber = minimo + (int) (Math.random() * (maximo - minimo + 1));
